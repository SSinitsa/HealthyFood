...
public class CreateRatingServiceTest extends AbstractTest {
	...
	public void deleteCreatedRecipe() {
		 ...
		 * serviceUser.delete(savedAuthorId); serviceUser.delete(savedUserId);
		 */
	}
	...
	public void createTest() {
		...
		rating.setUserId(savedAuthorId);
		rating.setRecipeId(savedRecipeId);
		rating.setVote((int) (Math.random() * 10));
		serviceRating.save(rating);
