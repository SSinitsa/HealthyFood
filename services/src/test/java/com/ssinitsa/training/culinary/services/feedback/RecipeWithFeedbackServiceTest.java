...
public class RecipeWithFeedbackServiceTest extends AbstractTest {
	...
	public void deleteTest()	{
		List<RecipeWithFeedback> recipeWithFeedback = serviceFeedback.getRecipeWithFedback(2);
		System.out.println(recipeWithFeedback.toString());
		/*
