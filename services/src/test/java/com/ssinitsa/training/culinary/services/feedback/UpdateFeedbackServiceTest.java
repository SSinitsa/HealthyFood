...
public class UpdateFeedbackServiceTest extends AbstractTest {
	...
	public void deleteTest()	{
		...
		updatedFeedback.setId(savedFeedbackId);
		updatedFeedback.setText("bla-bla-bla updated");
		serviceFeedback.save(updatedFeedback);
		System.out.println(serviceFeedback.get(savedFeedbackId).toString());
		/*
