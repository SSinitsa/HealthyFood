...
public class RecipeWithRatingServiceTest extends AbstractTest {
	...
	public void deleteTest()	{
		List <RecipeWithRating> recipeWithRatings = serviceRating.getRecipeWithRating(savedRecipeId);
		System.out.println(recipeWithRatings.toString());
		
		System.out.println(serviceRating.getAverageRating(34));
		/*
