...
public class GetRecipeWithDetailsServiceTest extends AbstractTest{
	...
	public void getRecipeWithDetailsTest(){
		List<RecipeWithDetails> recipeWithDetails = serviceRecipeDetails.getWithDetails(savedRecipeId);
		System.out.println(recipeWithDetails.toString());
